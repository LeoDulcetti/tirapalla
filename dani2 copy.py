...
# Logo Image Path
logo_path = "/Users/leonardodulcetti/Desktop/Dani/Screenshot 2024-11-27 at 21.54.30.png"  # Replace with your logo path
...
# Display Logo
st.image(logo, width=300)  # Adjust the width of the logo as needed
...
if uploaded_file is not None:
    ...
    st.sidebar.markdown("""
        <p>¡Sube una foto de perfil para personalizar tu experiencia!</p>
    """)
...
if st.button("¡Recomiéndame!"):
    if name and surname and hobby:
        st.markdown(f"### Hola {name} {surname}! Aquí tienes tus recomendaciones para {hobby}:")
        ...
        for event in events:
            ...
            # Add call button
            st.button(f"Llamar: +34647377604 para {event['title']}")
